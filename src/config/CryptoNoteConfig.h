...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x374bd0;
...
const uint32_t MIXIN_LIMITS_V1_HEIGHT                        = 122500;
...
const char     CRYPTONOTE_NAME[]                             = "Hekaton";
...
const int      P2P_DEFAULT_PORT                              =  19812;
const int      RPC_DEFAULT_PORT                              =  19813;
const int      SERVICE_DEFAULT_PORT                          =  8877;
...
const char* const SEED_NODES[] = {
 "144.91.113.228:19812", //Germany
  "167.86.113.17:19812", //Tokyo Seed
};
} // CryptoNote
